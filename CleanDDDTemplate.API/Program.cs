...
namespace CleanDDDTemplate.API
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddDbContext<CleanDDDTemplateDbContext>(options =>
              options.UseSqlServer(builder.Configuration.GetConnectionString("Building_A_Web_APIConnectionStringDDD")));
